...
Public Class ZkprojectzonderklachtDlg
    ...
    Private Sub ZkprojectzonderklachtDlg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim m_command = New OleDbCommand("SELECT tbl_klant.*, tbl_klacht.klacht_ID FROM tbl_klant LEFT JOIN tbl_klacht ON tbl_klant.projectcode = tbl_klacht.projectcode " _
                            & " WHERE (((tbl_klacht.klacht_ID) Is Null)) ORDER BY tbl_klant.projectcode", m_connection)
